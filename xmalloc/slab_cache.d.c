...
#define SLAB_INDEX(size) \
		(((unsigned long)(size) >>  2) <= 20 ?  -1 + ((unsigned long)(size) >>  2) : \
		 ((unsigned long)(size) >>  3) <= 20 ?   9 + ((unsigned long)(size) >>  3) : \
		 ((unsigned long)(size) >>  4) <= 20 ?  19 + ((unsigned long)(size) >>  4) : \
		 ((unsigned long)(size) >>  5) <= 20 ?  29 + ((unsigned long)(size) >>  5) : \
		 ((unsigned long)(size) >>  6) <= 20 ?  39 + ((unsigned long)(size) >>  6) : \
		 ((unsigned long)(size) >>  7) <= 20 ?  49 + ((unsigned long)(size) >>  7) : \
		 ((unsigned long)(size) >>  8) <= 20 ?  59 + ((unsigned long)(size) >>  8) : \
		 ((unsigned long)(size) >>  9) <= 20 ?  69 + ((unsigned long)(size) >>  9) : \
		 ((unsigned long)(size) >> 10) <= 20 ?  79 + ((unsigned long)(size) >> 10) : \
		 ((unsigned long)(size) >> 11) <= 20 ?  89 + ((unsigned long)(size) >> 11) : \
		 ((unsigned long)(size) >> 12) <= 20 ?  99 + ((unsigned long)(size) >> 12) : \
		 ((unsigned long)(size) >> 13) <= 20 ? 109 + ((unsigned long)(size) >> 13) : \
		 ((unsigned long)(size) >> 14) <= 20 ? 119 + ((unsigned long)(size) >> 14) : \
		 ((unsigned long)(size) >> 15) <= 20 ? 129 + ((unsigned long)(size) >> 15) : \
		 ((unsigned long)(size) >> 16) <= 20 ? 139 + ((unsigned long)(size) >> 16) : \
						       -1 )
...
static struct sized_slab_cache sized_caches[] = {
	/*     4*10 */ CI(4),CI(8),CI(12),CI(16),CI(20),CI(24),CI(28),CI(32),CI(36),CI(40),
		       CI(44),CI(48),CI(52),CI(56),CI(60),CI(64),CI(68),CI(72),CI(76),CI(80),
	...
	/*  1024*10 */ CI(11264),CI(12288),CI(13312),CI(14336),CI(15360),CI(16384),
		       CI(17408),CI(18432),CI(19456),CI(20480),
	/*  2048*10 */ CI(22528),CI(24576),CI(26624),CI(28672),CI(30720),CI(32768),
		       CI(34816),CI(36864),CI(38912),CI(40960),
	/*  4096*10 */ CI(45056),CI(49152),CI(53248),CI(57344),CI(61440),CI(65536),
		       CI(69632),CI(73728),CI(77824),CI(81920),
	/*  8192*10 */ CI(90112),CI(98304),CI(106496),CI(114688),CI(122880),CI(131072),
		       CI(139264),CI(147456),CI(155648),CI(163840),
#if 1
	/* 16384*10 */ CI(180224),CI(196608),CI(212992),CI(229376),CI(245760),CI(262144),
		       CI(278528),CI(294912),CI(311296),CI(327680),
	/* 32768*10 */ CI(360448),CI(393216),CI(425984),CI(458752),CI(491520),CI(524288),
		       CI(557056),CI(589824),CI(622592),CI(655360),
	/* 65536*10 */ CI(720896),CI(786432),CI(851968),CI(917504),CI(983040),CI(1048576),
		       CI(1114112),CI(1179648),CI(1245184),CI(1310720),
#endif
};
...
void* slab_malloc(slab_size_t size)
{
	...
	for (i = 0; i < sized_count; ++i) {
		if (size <= sized_caches[i].size) {
			...
			if (addr != NULL) {
	fprintf(stderr, "slab-malloc(%ld): sc=%p, addr=%p\n", (long)size, sized_caches[i].sc, addr);
				return addr;
			}
...
void* slab_realloc(void* old, slab_size_t nsize)
{
	...
	if (addr != NULL && old != NULL) {
		...
		fprintf(stderr, "slab-realloc: sc=%p, old=%p, addr=%p\n", sc, old, addr);
		if (sc == NULL) {
			slab_free(addr);
		}
		else {
...
void slab_free(void* addr)
{
	...
	fprintf(stderr, "slab-free: sc=%p, addr=%p\n", sc, addr);
}
